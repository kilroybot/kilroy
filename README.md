...
see `kilroy/README.md`
or [docs](https://kilroybot.github.io/kilroy).
...
write the tests and put them in `kilroy/tests`.
...
Docs should be placed in `kilroy/docs/docs`. They
are pretty straightforward to write.

To build the docs,
`cd` into `kilroy/docs` and run:
